...
export default function OrbitImages({
  ...
  customPath,
  baseWidth = 1400,
  baseHeight, // Optional: defaults to baseWidth
  radiusX = 700,
  radiusY = 170,
  radius = 300,
  starPoints = 5,
  ...
  const resolvedBaseHeight = baseHeight || baseWidth;
  const designCenterX = baseWidth / 2;
  const designCenterY = resolvedBaseHeight / 2;
  ...
  return (
    <div
      ...
      style={{
        ...
        aspectRatio: responsive ? `${baseWidth} / ${resolvedBaseHeight}` : undefined,
      }}
      aria-hidden="true"
    >
      <div
        ...
        style={{
          ...
          height: responsive ? resolvedBaseHeight : '100%',
        ...
        >
          {showPath && (
            <svg
              width="100%"
              height="100%"
              viewBox={`0 0 ${baseWidth} ${resolvedBaseHeight}`}
